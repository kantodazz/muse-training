...
{
    public partial class WorkInProgressMovementRPT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("WorkInProgressMovementRPT.rpt"));
                ...
                WorkInProgressMovement.ReportSource = report;
            }
        }
        ...
        protected void Page_Unload(object sender, EventArgs e)
        {
            report.Close();
            report.Dispose();
            WorkInProgressMovement.Dispose();
        }
    }
}