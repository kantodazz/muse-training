...
{
    public partial class PrePaymentMovementRPT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("PrePaymentMovementP.rpt"));
                ...
                PrePaymentMovement.ReportSource = report;
            }
        }
