...
{
    public partial class InventoryMovementRPT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("InventoryIssuingMovementP.rpt"));
                ...
                InventoryMovement.ReportSource = report;
