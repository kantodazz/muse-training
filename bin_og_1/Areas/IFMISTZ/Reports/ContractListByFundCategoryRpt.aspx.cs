...
{
    public partial class ContractListByFundCategoryRpt : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("ContractListByFundCategoryRpt.rpt"));
                ...
                ContractListByFundCategoryRPT.ReportSource = report;
            }
        ...
        protected void Page_Unload(object sender, EventArgs e)
        {
            report.Close();
            report.Dispose();
            ContractListByFundCategoryRPT.Dispose();
        }
    }
}