...
{
    public partial class BudgetByCategoryRPT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("BudgetByCategoryRPT.rpt"));
                ...
                BudgetByCategory.ReportSource = report;
            }
