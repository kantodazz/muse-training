...
{
    public partial class ConsoFundReceivedByCategoryRPT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("ConsoFundReceivedByCategoryRPT.rpt"));
               ...
               //report.SetParameterValue("@CostCenter", queryString["cost-center"]);
                ...
                ConsoFundReceivedByCategory.ReportSource = report;
            }
        ...
        protected void Page_Unload(object sender, EventArgs e)
        {
            report.Close();
            report.Dispose();
            ConsoFundReceivedByCategory.Dispose();
        }
    }
}