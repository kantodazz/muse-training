...
{
    public partial class ExpenditureByCategoryRPT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("ExpenditureByCategoryRPT.rpt"));
                ...
                ExpenditureByCategory.ReportSource = report;
            }
