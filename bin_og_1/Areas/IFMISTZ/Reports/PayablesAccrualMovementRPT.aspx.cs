...
{
    public partial class PayablesAccrualMovementRPT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("PayablesAccrualMovementP.rpt"));
                ...
                PayablesAccrualMovement.ReportSource = report;
            }
        ...
        protected void Page_Unload(object sender, EventArgs e)
        {
            report.Close();
            report.Dispose();
            PayablesAccrualMovement.Dispose();
        }
    }
}