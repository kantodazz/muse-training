...
{
    public partial class ConsoExpenditureByCategoryRPT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("ConsoExpenditureByCategoryRPT.rpt"));
               ...
               //report.SetParameterValue("@Period", queryString["period"]);
                ...
                ConsoExpenditureByCategory.ReportSource = report;
            }
        ...
        protected void Page_Unload(object sender, EventArgs e)
        {
            report.Close();
            report.Dispose();
            ConsoExpenditureByCategory.Dispose();
        }
    }
}