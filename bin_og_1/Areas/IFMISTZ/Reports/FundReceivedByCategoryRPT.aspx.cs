...
{
    public partial class FundReceivedByCategoryRPT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("FundReceivedByCategoryRPT.rpt"));
                ...
                FundReceivedByCategory.ReportSource = report;
            }
        ...
        protected void Page_Unload(object sender, EventArgs e)
        {
            report.Close();
            report.Dispose();
            FundReceivedByCategory.Dispose();
        }
    }
}