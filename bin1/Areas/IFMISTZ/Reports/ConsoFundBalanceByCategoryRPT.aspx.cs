...
{
    public partial class ConsoFundBalanceByCategoryRPT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("ConsoFundBalanceByCategoryRPT.rpt"));
                ...
                ConsoFundBalanceByCategory.ReportSource = report;
            }
        ...
        protected void Page_Unload(object sender, EventArgs e)
        {
            report.Close();
            report.Dispose();
            ConsoFundBalanceByCategory.Dispose();
        }
    }
}