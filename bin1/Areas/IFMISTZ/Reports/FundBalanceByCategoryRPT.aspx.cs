...
{
    public partial class FundBalanceByCategoryRPT : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                report.Load(Server.MapPath("FundBalanceByCategoryRPT.rpt"));
                ...
                FundBalanceByCategory.ReportSource = report;
            }
